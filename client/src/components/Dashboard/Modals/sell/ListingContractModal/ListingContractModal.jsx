            ...
            return (
              <div className="memo-container" key={item._id}>
                ...
                <div className="banner">
                  ...
                  <img
                    className="comapny-logo shadow"
                    src={item.companyLogo ? item.companyLogo.url : logo}
                    alt=""
                  />
                </div>
                  ...
                  <>
                    ...
                    <ul className="property_manager_details">
                      <li>
                        <hi.HiShieldCheck />
                        Incorporation date:{" "}
                        {item.incorporationDate && item.incorporationDate}
                      </li>
                      <li>
                        <hi.HiShieldCheck />
                        Countries operating in:{" "}
                        {item.details && item.details.location.country}
                      </li>
                      <li>
                        <hi.HiShieldCheck />
                      ...
                      <li>
                        <hi.HiShieldCheck />
                        Company Owner:{" "}
                        {item.companyAcquisition &&
                          item.companyAcquisition.directors}
                      </li>
                      <li>
                        <hi.HiShieldCheck />
                        Reason for selling:{" "}
                        {item.saleDetails && item.saleDetails.reasonForSelling}
                      </li>
                    </ul>
                  </>
                )}
                          ...
                          <tr>
                            ...
                            <td>
                              {item.teamInformation &&
                                item.teamInformation.howBigIsTeam}
                            </td>
                          </tr>
                          <tr>
                            ...
                            <td>
                              {item.booking &&
                                item.booking.details.directBookingOnWebsite}
                            </td>
                          </tr>
                        </tbody>
                      </Table>
                  ...
                  <div className="managment-summary ms-listing-contract row flex-md-nowrap">
                    <div className="left col-md-8">
                      ...
                      <div className="true-false-div">
                        <span>
                          Are all employees on the same type of contract and
                          termination clauses?
                        </span>
                        <span>
                          {item.teamInformation.areEmployeesOnSameContract}
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="managment-summary ms-listing-contract row flex-md-nowrap">
                    <div className="left col-md-8">
                      ...
                      <div className="true-false-div">
                        ...
                        <span>
                          {item.ownersAndProperties.ownerHaveSameContract}
                        </span>
                      </div>
                      <div className="true-false-div">
                        <span>What are the termination clauses? </span>
                        <span>
                          {item.ownersAndProperties.terminationClauses}
                        </span>
                      </div>
                      <div className="true-false-div">
                        <span>
                          Are they renewed yearly actively or by default?{" "}
                        </span>
                        <span>{item.ownersAndProperties.howRenewed}</span>
                      </div>
                      <div className="true-false-div">
                        <span>
                          Do you need to agree any yearly terms with owners such
                          as pricing?
                        </span>
                        <span>
                          {item.ownersAndProperties.agreeOnYearlyTerm}
                        </span>
                      </div>
                      <div className="true-false-div">
                        <span>
                        ...
                        <span>
                          {item.ownersAndProperties.customerAquisitionCost}
                        </span>
                      </div>
                      <div className="true-false-div">
                        <span>
                        ...
                        <span>
                          {item.ownersAndProperties.avgNetProfitEachProperty}
                        </span>
                      </div>

                      <div className="pm-heading mt-5 mb-3">
                        <span className="mb-3">
                          What types of properties are rented and what is their
                      ...
                      <Table bordered>
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                              {
                                item.ownersAndProperties.typesOfRentedProperties
                    ...
                    <div className="left col-md-8">
                      ...
                      <Table bordered>
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td>
                              Direct bookings over the phone (not enquiries)
                            </td>
                            <td>
                              {item.booking.details.directBookingOverPhone}
                            </td>
                          </tr>
                          <tr>
                            <td>Airbnb</td>
                      ...
                      <Table bordered>
                        ...
                        <tbody>
                          <tr>
                            ...
                            {item.booking.makeupOfBooking.totalBookings?.map(
                              (data, i) => (
                                <>
                                  <td>{data.year19}</td>
                                  <td>{data.year20}</td>
                          ...
                          <tr>
                            <td>
                              Average number of nights booked per property
                            </td>
                            {item.booking.makeupOfBooking.avgNightBookedPerYear?.map(
                              (data, i) => (
                                <>
                                  <td>{data.year19}</td>
                                  <td>{data.year20}</td>
                          ...
                          <tr>
                            ...
                            {item.booking.makeupOfBooking.customerPercentageRepeatBooking?.map(
                              (data, i) => (
                                <>
                                  <td>{data.year19}</td>
                                  <td>{data.year20}</td>
                          ...
                          <tr>
                            ...
                            {item.booking.makeupOfBooking.percentGuestCancel?.map(
                              (data, i) => (
                                <>
                                  <td>{data.year19}</td>
                                  <td>{data.year20}</td>
                          ...
                          <tr>
                            <td>
                              What was the average advance booking window?
                            </td>
                            {item.booking.makeupOfBooking.avgAdvanceBookingWindow?.map(
                              (data, i) => (
                                <>
                                  <td>{data.year19}</td>
                                  <td>{data.year20}</td>
                          ...
                          <tr>
                            ...
                            {item.booking.makeupOfBooking.avgAdr?.map(
                              (data, i) => (
                                <>
                                  <td>{data.year19}</td>
                                  <td>{data.year20}</td>
                          ...
                          <tr>
                            ...
                            {item.booking.makeupOfBooking.avgStayTimes?.map(
                              (data, i) => (
                                <>
                                  <td>{data.year19}</td>
                                  <td>{data.year20}</td>
                    ...
                    <div className="left col-md-8">
                      ...
                      <Table bordered>
                        <tbody>
                          <tr>
                            <td>
                              Automation messaging for confirmation of booking
                              and other details, such as balance payment due
                              etc?{" "}
                            </td>
                          ...
                          <tr>
                            <td>
                              Automation messaging for confirmation of the
                              payment?{" "}
                            </td>
                          ...
                          <tr>
                            <td>
                              Other automated information on location and
                              property?{" "}
                            </td>
                          ...
                          <tr>
                            <td>
                              Link to a guest app which may or may not include
                              3?{" "}
                            </td>
                          ...
                          <tr>
                            <td>
                              Mailed paperwork, thank you message or freebies?{" "}
                            </td>
                            <td>{item.guests.mailedPaperwork}</td>
                          </tr>
                          <tr>
                            <td>
                              Pre arrival information (key access, times,
                              support contact details etc
                            </td>
                          ...
                          <tr>
                            <td>
                              Do guests have access to a guest login section to
                              see their bookings and entry codes etc?{" "}
                            </td>
                            <td>{item.guests.guestHaveAccessToLogin}</td>
                          </tr>
                          <tr>
                            <td>
                              Do guests have access to a separate mobile app
                            </td>
